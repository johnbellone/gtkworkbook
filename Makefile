...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"gtkworkbook\" -DPACKAGE_TARNAME=\"gtkworkbook\" -DPACKAGE_VERSION=\"0.12\" -DPACKAGE_STRING=\"gtkworkbook\ 0.12\" -DPACKAGE_BUGREPORT=\"j_bellone@users.sourceforge.net\" -DPACKAGE=\"gtkworkbook\" -DVERSION=\"0.12\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DHAVE_LIBPTHREAD=1 -DHAVE_ARPA_INET_H=1 -DHAVE_NETDB_H=1 -DHAVE_NETINET_IN_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_SYS_SOCKET_H=1 -DHAVE_UNISTD_H=1 -DHAVE__BOOL=1 -DHAVE_STDBOOL_H=1 -DHAVE_GETHOSTBYNAME=1 -DHAVE_MEMSET=1 -DHAVE_SOCKET=1
DEPDIR = .deps
DSYMUTIL = 
DUMPBIN = 
ECHO_C = 
...
OTOOL64 = 
PACKAGE = gtkworkbook
PACKAGE_BUGREPORT = j_bellone@users.sourceforge.net
